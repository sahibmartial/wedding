...
<div class="row">
	<div class="col-md-4 mb-4">
		<div class="card" style="width: 18rem;">
         ...
         <img src="{{ asset('assets/img/logo5.png')}}" class="card-img-top" alt="logo">
           ...
           <div class="card-body">	
			...
			<h6 class="card-subtitle mb-2 text-muted">Digital</h6>
              <p class="card-text">
                ...
                Avec  nous, la data plus qu'un outil decisionnel et de marketing mais un outil d'optimissation pour booster votre actvité. </p>
	...
	<div class="col-md-4">
		<div class="card" style="width: 18rem;">
         ...
         <img src="{{asset('assets/img/logo5.png')}}" class="card-img-top" alt="decoration">

           <div class="card-body">
           	<h5 class="card-title">MAYA-</h5>
			<h6 class="card-subtitle mb-2 text-muted">Events</h6>
              <p class="card-text">Nous offrons une presation dans la décoration et l'organisation de vos évènements.<br>
	...
	<div class="col-md-4">
		<div class="card" style="width: 18rem;">
			<img src="{{asset('assets/img/logo5.png')}}" class="card-img" alt="decoration">
			<img src="{{asset('assets/img/logo5.png')}}" class="card-img-top" alt="decoration">
			<div class="card-body">
				<h5 class="card-title">MAYA-</h5>
				<h6 class="card-subtitle mb-2 text-muted">Couture</h6>
				<p class="card-text">
				Nous réalisons des tenues pour femmes et hommes, ainsi des sets de tables 
				<br>
